...
const ForgotPasswordPage = () => {
  ...
  const verifyCode = async (event) => {
    ...
    try {
      ...
      setTimeout(() => { setDigits(Array(6).fill('')); setStatus('idle'); inputs.current[0]?.focus() }, 1800)
    }
  }
