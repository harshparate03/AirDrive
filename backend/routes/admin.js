...
router.get('/health', async (req, res) => {
  ...
  res.json({
    ...
    services: [
      ...
      { name: 'Email', status: process.env.BREVO_API_KEY || ((process.env.GMAIL_USER || process.env.EMAIL_USER) && (process.env.GMAIL_APP_PASSWORD || process.env.EMAIL_PASS)) ? 'operational' : 'not_configured', detail: process.env.BREVO_API_KEY ? 'Brevo HTTPS email API' : 'SMTP configuration' },
